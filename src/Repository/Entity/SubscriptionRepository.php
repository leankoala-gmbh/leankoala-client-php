...
class SubscriptionRepository extends Repository  {
  ...
  {
    $route = ['path' => '/kapi/v1/subscription/company/{company}/', 'method' => 'GET', 'version' =>  1];
  ...
  {
    $route = ['path' => '/kapi/v1/subscription/company/{company}/plans/creditcard', 'method' => 'POST', 'version' =>  1];
    $argList = array_merge(['company' => $company], $args);
  ...
  {
    $route = ['path' => '/kapi/v1/subscription/company/{company}/plans/free', 'method' => 'POST', 'version' =>  1];
    $argList = array_merge(['company' => $company], $args);
  ...
  {
    $route = ['path' => '/kapi/v1/subscription/user/{user}/plans/free', 'method' => 'POST', 'version' =>  1];
  ...
  {
    $route = ['path' => '/kapi/v1/subscription/company/{company}/creditcard', 'method' => 'POST', 'version' =>  1];
    $argList = array_merge(['company' => $company], $args);
  ...
  {
    $route = ['path' => '/kapi/v1/subscription/company/{company}/billingaddress', 'method' => 'POST', 'version' =>  1];
    $argList = array_merge(['company' => $company], $args);
  ...
  {
    $route = ['path' => '/kapi/v1/subscription/company/{company}/billingaddress', 'method' => 'GET', 'version' =>  1];
    $argList = array_merge(['company' => $company], $args);
  ...
  {
    $route = ['path' => '/kapi/v1/subscription/company/{company}/features', 'method' => 'GET', 'version' =>  1];
    $argList = array_merge(['company' => $company], $args);
  ...
  {
    $route = ['path' => '/kapi/v1/subscription/company/{company}/invoices', 'method' => 'GET', 'version' =>  1];
    $argList = array_merge(['company' => $company], $args);
  ...
  {
    $route = ['path' => '/kapi/v1/subscription/user/{user}/plan', 'method' => 'POST', 'version' =>  1];
    $argList = array_merge(['user' => $user], $args);
  ...
  {
    $route = ['path' => '/kapi/v1/subscription/company/{company}/quota', 'method' => 'GET', 'version' =>  1];
    $argList = array_merge(['company' => $company], $args);
  ...
  {
    $route = ['path' => '/kapi/v1/subscription/trial/{providerIdentifier}/end', 'method' => 'POST', 'version' =>  1];

...
class CheckDeadLinksRepository extends Repository  {
  ...
  {
    $route = ['path' => '/kapi/v1/check/checks/{system}/deadlinks', 'method' => 'GET', 'version' =>  1];
   ...
   * @param {Object} args
   */
  public function getResultsByCompany($company, array $args = [])
  {
    $route = ['path' => '/kapi/v1/check/checks/company/{company}/deadlinks', 'method' => 'GET', 'version' =>  1];
   ...
   * @param {Object} args
   */
  public function getConfiguration($system, array $args = [])
  {
    $route = ['path' => '/kapi/v1/check/checks/{system}/deadlinks/config', 'method' => 'GET', 'version' =>  1];
    $argList = array_merge(['system' => $system], $args);
   ...
   */
  public function ignorePattern($system, array $args = [])
  {
    $route = ['path' => '/kapi/v1/check/checks/{system}/deadlinks/ignore', 'method' => 'POST', 'version' =>  1];
    $argList = array_merge(['system' => $system], $args);
   ...
   */
  public function unignorePattern($system, array $args = [])
  {
    $route = ['path' => '/kapi/v1/check/checks/{system}/deadlinks/unignore', 'method' => 'POST', 'version' =>  1];
    $argList = array_merge(['system' => $system], $args);
   ...
   * @param {Object} args
   */
  public function getBlockedPatterns(array $args = [])
  {
    $route = ['path' => '/kapi/v1/check/checks/deadlinks/blocked', 'method' => 'GET', 'version' =>  1];

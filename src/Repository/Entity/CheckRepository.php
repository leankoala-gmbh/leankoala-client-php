...
class CheckRepository extends Repository  {
   ...
   */
  public function addByChecklist($system, $args)
  {
    $route = ['path' => 'check/checks/{system}/checklist', 'method' => 'POST', 'version' =>  1];
   ...
   */
  public function addByRecipe($args)
  {
    $route = ['path' => 'check/checks/cookbook', 'method' => 'POST', 'version' =>  1];
   ...
   * @param {Object} args
   */
  public function runChecksForSystem($system, $toolIdentifier, $args)
  {
    $route = ['path' => 'check/checks/run/{system}/{toolIdentifier}', 'method' => 'POST', 'version' =>  1];
   ...
   */
  public function showCollections($project, $toolIdentifier, $args)
  {
    $route = ['path' => 'check/collections/{project}/{toolIdentifier}', 'method' => 'POST', 'version' =>  1];
   ...
   * @param {String} args.group The collection group. It is used to specify the collections. (default: )
   */
  public function showActiveCollections($system, $toolIdentifier, $args)
  {
    $route = ['path' => 'check/collections/system/active/{system}/{toolIdentifier}', 'method' => 'POST', 'version' =>  1];
    $argList = array_merge(['system' => $system, 'toolIdentifier' => $toolIdentifier], $args);
   ...
   * @param {String} args.group The collection group. It is used to specify the collections. (default: )
   */
  public function updateCollections($system, $args)
  {
    $route = ['path' => 'check/collections/system/{system}', 'method' => 'PUT', 'version' =>  1];
    $argList = array_merge(['system' => $system], $args);

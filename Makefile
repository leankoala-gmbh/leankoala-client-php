...
.PHONY: init
init: composer-update-app composer-install-dev-ops ## Install composer dependencies
...
cs-fix: ## Run php-cs-fixer
	...
	php dev-ops/ci/vendor/bin/php-cs-fixer fix --config dev-ops/ci/config/.php-cs-fixer.legacy.php
